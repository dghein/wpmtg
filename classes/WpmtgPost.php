...
class WpmtgPost
{
    public function registerWpmtgPostType()
    {
         ...
         */
        $icon = 'data:image/svg+xml;base64,' . base64_encode('<svg enable-background="new 0 0 600 600" version="1.1" viewBox="0 0 600 600" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
